...
class ApiServices {
  ...
  Future<MovieModel> getNowPlayingMovies() async {
    ...
    final response = await http.get(Uri.parse(url), headers: {
      'Authorization':
      'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJhN2Q1NzcyZDA1YTI2YjVhYmY0NjBhNzVmZGVmOGMzNSIsInN1YiI6IjY2NDJkZGIxYjVmM2RlY2Q0NmJhOTE5NCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.eUOFZYg2Gunttr4HhYoiIumB_lMl0wWZiwcoU-Q366o'
    });
